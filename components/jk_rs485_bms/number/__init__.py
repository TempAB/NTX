...
NUMBERS = {
    ...
    CONF_PRECHARGING_TIME_FROM_DISCHARGE:                   [0x010C, 0x11,   0x04,  0,  0],   ############### TO VERIFY !!!

    CONF_CELL_REQUEST_CHARGE_VOLTAGE_TIME:                  [0x0104, 0x15,   0x02,  1,  0],
    CONF_CELL_REQUEST_FLOAT_VOLTAGE_TIME:                   [0x0104, 0x15,   0x02,  1,  0],

    CONF_VOLTAGE_CALIBRATION:                               [0x0000, 0x16,   0x04,  3,  0],
    CONF_CURRENT_CALIBRATION:                               [0x0006, 0x16,   0x04,  3,  0],
...
if hasattr(number, "number_schema"):
    JK_RS485_NUMBER_SCHEMA = (
        number.number_schema(JkRS485BmsNumber)
